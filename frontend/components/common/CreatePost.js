        ...
        >
          {!noTitle && (
            <div className="w-full p-2">
              <input
                type="text"
                className="bg-slate-200 rounded-xl p-4 my-4 w-full border-none focus:border-transparent outline-none focus:ring-0 "
          ...
          <div className="w-full p-2">
            <textarea
              ...
              cols={50}
              className={
                "bg-slate-200 rounded-xl p-4 w-full border-none focus:border-transparent outline-none focus:ring-0 "
              }
              value={content}
          ...
          <div className="mt-1 flex items-center align-middle">
            ...
            <MdOutlinePoll
              className="cursor-pointer text-3xl mb-auto"
