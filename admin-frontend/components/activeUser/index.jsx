...
const ActiveUser = ({ isActive, user }) => {
  ...
  const handleUserClick = () => {
    ...
    if (userId) {
      router.push(`/partner/user/${userId}`);
    }
  };
  ...
  return (
    <div 
      className="flex items-center gap-4 bg-white border border-gray-200 p-4 rounded-lg mb-4 hover:shadow-md transition-all duration-200 cursor-pointer group"
