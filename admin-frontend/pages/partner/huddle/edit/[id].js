...
function EditPartnerHuddlePage() {
  ...
  const fetchCommunities = async () => {
    try {
      const response = await api.get(`/partner/${user?.id}/communities`);
      console.log('Partner communities response:', response.data);
      if (response.data) {
          ...
          <div className="bg-white rounded-xl shadow-md p-6 sm:p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <select
                      ...
                      onChange={handleInputChange}
                      className="w-full px-4 py-2 pl-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 bg-gray-50 appearance-none"
                      required
                      disabled
                    >
                    ...
                    {formData.communityId && communities.find(c => c.id === parseInt(formData.communityId)) && (
                      <div className="absolute left-3 top-1/2 transform -translate-y-1/2 pointer-events-none">
                        <img
                          src={communities.find(c => c.id === parseInt(formData.communityId))?.bannerImg || 'https://via.placeholder.com/40'}
                          alt="Community"
              ...
              <div className="flex items-center justify-end gap-4 pt-6 border-t">
                <button
                  type="button"
                  onClick={() => router.push(`/partner/huddle/${id}`)}
...
export default EditPartnerHuddlePage;
