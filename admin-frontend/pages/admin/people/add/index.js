...
export default function AddPeople() {
  ...
  const onSubmitIndividual = async (data) => {
    setLoading(true);
    try {
      const response = await api.post('/auth/signup', { ...data, userType: "user" });
          ...
          <Box sx={{ textAlign: 'center', py: 3 }}>
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                Download the template and fill in the user details. The CSV file should contain columns for name, email, phone, password, and pincode.
              </Typography>
              <Link href="/templates/users-template.csv" download>
                <Button
                  variant="outlined"
