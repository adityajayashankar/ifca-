...
const AddEvaluatorModal = () => {
  ...
  return (
    <>
      <div
        onClick={handleOpen}
        className="bg-primary-500 px-4 py-2 cursor-pointer hover:shadow text-white text-sm font-semibold shadow mr-4 mt-4 rounded-lg"
      >
        Add Evaluator
      </div>
        ...
        >
          ...
          <div className="  flex flex-col justify-around  h-fit   gap-3">
            ...
            <div className="flex flex-row-reverse gap-4">
              ...
              <button
                type="submit"
                className="bg-primary-500 text-white rounded px-4 py-2 font-semibold"
              >
                Create
              </button>
            </div>
