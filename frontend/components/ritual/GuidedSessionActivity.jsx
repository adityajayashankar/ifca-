...
export default function GuidedSessionActivity({ activity, activityData, isModerator }) {
  ...
  // Memoize currentInstruction to prevent it from changing reference every render
  const currentInstruction = useMemo(() => instructions[currentStep], [instructions, currentStep]);
