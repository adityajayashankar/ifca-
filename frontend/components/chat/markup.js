...
const Markup = ({ data, setData, status, onClick, showBtn = true }) => {
  const modules = {
    toolbar: [
  ...
  return (
    <div className="flex bg-white  justify-center">
      <div className="flex w-full flex-row bg-white p-3 overflow-hidden rounded-2xl">
        <div className="w-full text-black border-none">
          ...
          {/* <MarkupWithUpload data={data} setData={setData} /> */}
        </div>
        {showBtn && (
