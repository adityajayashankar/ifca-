exports.mailTemplate = function({ name, h1, h2, h3, main, content }){
    return ` <!DOCTYPE html>
    <html
        ...
        <style type="text/css">
          ...
          @media (max-width: 480px) {
            #u_content_text_6 .v-container-padding-padding {
              padding: 30px 24px 33px !important;
            }
          }
                                      ...
                                      <tr>
                                        ...
                                        >
                                          <img
                                            align="center"
                                            border="0"
                                            src="https://getsubspace.tech/subspace-white-logo.jpg"
                                            alt="Subspace logo"
                                            title="Image"
                                            style="
                                              outline: none;
...
// h2 => Welcome to Seminar Room
// main =>Your temporary password is mentioned. Please change it in your user portal.