  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto">
        <div className="relative w-full max-w-lg mx-auto bg-white rounded-2xl shadow-2xl p-0 flex flex-col max-h-[90vh] overflow-hidden animate-fadeInUp">
          {/* Close Button */}
          <button
          ...
          <div className="flex-1 overflow-y-auto" style={{ maxHeight: '80vh' }}>
            {/* Render the same content as before, but without Drawer */}
            {showSelectedUsers ? (
              ...
              <>
                ...
                >
                  <MenuItem onClick={handlePrivacySettingsClick}>
                    Privacy Settings
                  </MenuItem>
                ...
                {loading ? (
                  ...
                  <Box sx={{ flexGrow: 1, overflow: 'hidden' }}>
                    <List sx={{
                      height: pendingRequests?.length > 0 ? 'calc(80vh - 200px)' : 'calc(80vh - 100px)',
                      overflowY: 'auto',
                      '&::-webkit-scrollbar': {
                        width: '6px',
                      },
