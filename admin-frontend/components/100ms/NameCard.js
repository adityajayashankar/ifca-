...
function NameCard({ peer, showHandRaised = false, dominantSpeakerId, isModerator = false, permissions = null, localPeerId = null }) {
    ...
    return (
        <div className={`relative flex items-center gap-2 md:gap-3 p-1.5 md:p-2 rounded-lg transition-all duration-300 ${
            isSpeaking 
            ...
            <div className={`w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center flex-shrink-0 transition-all relative ${
                isSpeaking 
