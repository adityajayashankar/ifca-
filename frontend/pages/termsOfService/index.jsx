...
const TermsOfService = () => {
  return (
    <>
      <Topbar />
      <div className="px-4 md:px-10 py-10 mt-[80px]">
        ...
        <p>
          ...
          materials on IFCA's Website for personal, non-commercial
        ...
        <ul className="list-disc px-10">
          ...
          <li>
            attempt to reverse engineer any software contained on Startup
        ...
        <p>
          This will let IFCA to terminate upon violations of any
        ...
        <p>
          All the materials on IFCA's Website are provided "as
          is". IFCA makes no warranties, may it be expressed or
          implied, therefore negates all other warranties. Furthermore, Startup
          Roundtable does not make any representations concerning the accuracy
        ...
        <p>
          IFCA or its suppliers will not be hold accountable for
          any damages that will arise with the use or inability to use the
          materials on IFCA's Website, even if IFCA
        ...
        <p>
          The materials appearing on IFCA's Website may include
          technical, typographical, or photographic errors. IFCA
          will not promise that any of the materials in this Website are
          accurate, complete, or current. IFCA may change the
          materials contained on its Website at any time without notice. Startup
          Roundtable does not make any commitment to update the materials.
        </p>

        <h2>6. Links</h2>

        <p>
          IFCA has not reviewed all of the sites linked to its
          Website and is not responsible for the contents of any such linked
          site. The presence of any link does not imply endorsement by Startup
          Roundtable of the site. The use of any linked website is at the user's
          own risk.
        </p>
        ...
        <p>
          IFCA may revise these Terms of Use for its Website at
        ...
        <p>
          Any claim related to IFCA's Website shall be governed by
