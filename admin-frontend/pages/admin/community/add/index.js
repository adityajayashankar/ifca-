...
const CreateCommunity = () => {
  ...
  return (
    <div className='w-full bg-gray-50 flex flex-col max-h-[calc(100vh-70px)]'>
      {/* Breadcrumbs */}
      ...
      <div className="h-full flex-1 flex flex-col justify-center items-center w-full px-0 p-0 overflow-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-0  w-full overflow-auto">
          <CreateCommunityForm baseURL={'admin'}/>
        </div>
      </div>
    </div>
  )
